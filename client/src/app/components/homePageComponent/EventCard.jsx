    ...
    async function getEvents() {
      try {
        ...
        const response = await axios.get(
          `${BASE_URL}/user/events?featured=true`
        );
    ...
    <>
      {isLoading ? (
        ...
        <section className="mx-auto px-8 py-8 lg:py-40">
          <h1 className="text-2xl font-semibold text-black lg:text-4xl py-6">
            ...
            {Object.values(featuredEvents)
              ...
              .map((featuredEvent) => (
                <div
                  ...
                  className="border rounded-lg overflow-hidden shadow flex flex-col bg-gray-100"
                >
                  <img
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div>
                      <p className="text-xs font-semibold mb-1 ml-1 select-none">
                        Starting from $
                        {featuredEvent.tickets.length > 0
                          ? featuredEvent.tickets[0].price
                          : "N/A"}
                      </p>
                      {featuredEvent.availableSeats === 0 ? (
                        ...
                        <Link
                          ...
                          legacyBehavior
                        >
                          <button className="mb-2 mr-2 text-white transition-colors duration-150 border-2 border-stone-700 hover:border-stone-700 bg-stone-700 hover:bg-orange-300 hover:text-black px-4 py-2 rounded-full">
                            View Details
                          </button>
                        </Link>
                      )}
