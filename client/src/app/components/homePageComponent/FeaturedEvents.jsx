  ...
  useEffect(() => {
    async function getEvents() {
      try {
        ...
        const response = await axios.get(`${BASE_URL}/user/genre-list`);
  ...
  return (
    <>
      {isLoading ? (
        ...
        <section className="container mx-auto px-8 pb-8 lg:pb-40 lg:m-0">
          <h2 className="block antialiased tracking-normal font-sans text-4xl font-semibold leading-[1.3] text-blue-gray-900  lg:!text-4xl">
            Check our events genres
          </h2>
          <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-3">
            {Object.values(uniqueGenres)
              .slice(0, 6)
              .map((genre, index) => (
                <div
